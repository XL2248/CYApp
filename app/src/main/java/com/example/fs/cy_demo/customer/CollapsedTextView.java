package com.example.fs.cy_demo.customer;
...
public class CollapsedTextView extends TextView {
    ...
    /** 默认全文的Text*/
    private static final String EXPANDEDTEXT = "+ 点击查看全文";
    /** 默认收起的text*/
    private static final String COLLAPSEDTEXT = "- 点击收起";
    /** 全文的text*/
        ...
        if(allLines > 0) {
            getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                /* 计算行数 */
                    ...
                    allLines = (int) (tp.measureText(text) / showWidth);
                    if (lines > maxLine) {
